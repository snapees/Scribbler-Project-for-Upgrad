function toggleEditSave() {
  if (
    document.getElementById("postText").getAttribute("contentEditable") ===
    "true"
  ) {
    document
    ...
    document.getElementById("editPostButton").innerHTML =
...
function likePost() {
  document.getElementById("likePostBtn").innerHTML =
  ...
  if (numberOfClicks !== 0) {
    if (numberOfClicks == 1) {
      ...
      document.getElementById("likesCount").innerHTML =
        numberOfClicks + " people like this!";
    }
  }
}
